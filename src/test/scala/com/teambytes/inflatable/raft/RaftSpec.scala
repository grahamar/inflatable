...
abstract class RaftSpec(callingThreadDispatcher: Boolean = true, _system: Option[ActorSystem] = None)
  ...
  override def beforeAll() {
    ...
    raftConfiguration = ClusterConfiguration(isLocal = false, _members)
   ...
   * > Use the CallingThreadDispatcher for FSM tests, such as [[com.teambytes.inflatable.raft.CandidateTest]]
   */
